...
class CareerChatAssistant:
    def __init__(self, career_system=None):
        ...
        self.google_api_key = career_system.google_api_key if career_system else None
    ...
    def initialize_rag(self, career_data):
        ...
        if not self.google_api_key or not career_data:
            return False
        ...
        try:
            ...
            llm = ChatGoogleGenerativeAI(temperature=0.2, model_name="gemini-pro", api_key=self.google_api_key)
